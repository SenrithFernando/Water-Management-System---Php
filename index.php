...
<form action="body1.php" method="post" target="_self">
    ...
    <div class="input-group mb-3"><input type="text" name="cal" class="form-control" placeholder="Input Water Time Minitues" aria-label="Recipient's username" aria-describedby="button-addon2" value="<?php echo isset($ins) ? $ins : ''; ".00"?>" readonly>
